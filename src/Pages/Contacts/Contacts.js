...
export default function Contacts(){
    useEffect(() => {
        // Track page visit
        try {
            AnalyticsService.trackPageView('Contact', '/My_Portfolio/contact');
        } catch (error) {
        ...
        <div className="contacts">
            <div className="contacts__hero">
                <div className="contacts__hero-content">
                    <span className="contacts__tag">Get In Touch</span>
                    <h1>Let's Create Something Amazing Together</h1>
                    <p className="contacts__intro">
                        I'm always excited to connect with fellow developers, potential collaborators, 
                        or anyone interested in discussing technology, sustainability, or creative projects.
                    </p>
                </div>
                <div className="contacts__hero-image">
                    <img className="contacts__avatar" src={Avatar} alt="Contact Avatar"/>
                </div>
            </div>
            ...
            <div className="contacts__content">
                <div className="contacts__info">
                    <div className="contact__card">
                        ...
                        <p>
                            ...
                            or simply want to chat about the latest in web development, I'd love to hear from you.
                        </p>
                        
                        <div className="contact__details">
                            <div className="contact__item">
                                <h3>Email</h3>
                                <a href="mailto:lakannanji@gmail.com">lakannanji@gmail.com</a>
                            </div>
                        ...
                        <div className="social__section">
                            ...
                            <div className="socials">
                                <a href="https://github.com/Shaelle11" target="_blank" rel="noopener noreferrer" className="social__link">
                                ...
                                <a href="https://www.linkedin.com/in/nanji-lakan-theshaelle/" target="_blank" rel="noopener noreferrer" className="social__link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <a href="https://www.instagram.com/the_shaelle/" target="_blank" rel="noopener noreferrer" className="social__link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="contacts__form">
                    <form onSubmit={handleSubmit} className="contact__form">
                        ...
                        <p>Have a specific project or question? Drop me a line below!</p>
                        ...
                        <div className="form__group">
                            ...
                            <textarea 
                                ...
                                rows="6"
                                disabled={formStatus.isSubmitting}
                                className={formStatus.error && (!formData.message.trim() || formData.message.trim().length < 10) ? 'error' : ''}
                            ></textarea>
                        </div>
